nx = int(input('What is the amount of blocks in x-axis is'))
ny = int(input('What is the amount of blocks in y-axis is'))
nz = int(input('What is the amount of blocks  in z-axis is'))
