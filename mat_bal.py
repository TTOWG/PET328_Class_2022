...
nz=int(input('How many layers are in the z-axis '))
...
for k in range(1,nz+1):
	...
	Pi = float(input('What is the value of initial reservoir pressure for Layer{0}?'.format(k)))	boi = float(input('What is the value of initial oil FVF for Layer{0}?'.format(k)))# a typo error in the question ;Bo was  written instead of Boi
