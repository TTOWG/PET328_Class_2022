...
# Sample calls
volumetrics = stoiip_discretized(100, 100, 40, 2, 1, 1.2, [0.2, 0.2], [0.3, 0.3]) # Sample call 1
print(volumetrics)

(my_STOIIP, my_STOIIP_list) = stoiip_discretized(100, 100, 40, 2, 1, 1.2, [0.2, 0.2], [0.3, 0.3]) # Sample call 2: with the output tuple unpacked
